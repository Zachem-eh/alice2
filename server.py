...
cities = {
    'москва': ['997614/27d5bc0309ba9742a07f', '1030494/547a629a40b848679ab5'],
    'нью-йорк': ['1030494/1b36f4ceb73a4c9c5414', '997614/cc3c829ac119f58eac3a'],
    'париж': ["965417/10eda093c283f0e75648", '13200873/a09616b039ae1c2525dc'],
    'санкт-петербург': ['213044/c0db7636d0b40ebc0452', '13200873/f47bc4a57c0d03d3e1d4']
}
    ...
    if sessionStorage[user_id]['first_name'] is None:
        ...
        if not sessionStorage[user_id]['game_started']:
            if 'помощь' in req['request']['nlu']['tokens']:
                res['response']['text'] = 'В этой игре необходимо написать название города, показанного на картинке'
